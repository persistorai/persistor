...
# to warp-core, encrypted, so account loss is survivable.
#
...
# Scout backup public key, prunes to the newest 14. Restore procedure:
...
KEEP=14
PUBKEY_FILE="${SCOUT_SECRETS:-$HOME/.scout/secrets}/backup-pubkey.txt"
...
source "${SCOUT_SECRETS:-$HOME/.scout/secrets}/vault.env"
