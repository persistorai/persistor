...
make -C /home/user/code/persistor build-server
...
test tenant and must never bind a public interface or serve devbox's live
`demo:`/`claude:` memory. Per-tenant bearer tokens arrive in P2; real OAuth
