...
// command imports the operator's notes, Claude's auto-memory, or any markdown corpus —
...
func newImportCmd() *cobra.Command {
	...
	cmd.Flags().StringVar(&o.namespace, "namespace", "default", "Namespace to import the notes into (e.g. demo, claude)")
